...
//   TalonFX ArmMotor_slave = new TalonFX(motorPortConstants.ARM_MOTOR_SLAVE_PORT);
//   CANSparkMax ExtendMotor = new CANSparkMax(motorPortConstants.ARM_EXTEND_PORT, MotorType.kBrushless);
  ...
  public void update () {
    switch(currentPosition) {
      case STARTING: 
        setArmPosition(EncoderConstants.STARTING_COUNT);
      ...
      case FRONT_TOP:
        ...
        //   retractArm();
        // }
        if(lastPosition == ArmPosition.BACK_BOTTOM || lastPosition == ArmPosition.BACK_MIDDLE || lastPosition == ArmPosition.BACK_TOP){
            flipLimeServo();
        }
        setArmPosition(EncoderConstants.FRONT_TOP_COUNT);
        // extendArm();
      ...
      case FRONT_MIDDLE:
        ...
        setArmPosition(EncoderConstants.FRONT_MIDDLE_COUNT);
      ...
      case FRONT_BOTTOM:
        ...
        setArmPosition(EncoderConstants.FRONT_BOTTOM_COUNT);
      ...
      case BACK_TOP:
        ...
        //   retractArm();
        // }
        if(lastPosition == ArmPosition.FRONT_BOTTOM || lastPosition == ArmPosition.FRONT_MIDDLE || lastPosition == ArmPosition.FRONT_TOP){
            flipLimeServo();
        }
        setArmPosition(EncoderConstants.BACK_TOP_COUNT);
        // extendArm();
      ...
      case BACK_MIDDLE:
        ...
        setArmPosition(EncoderConstants.BACK_MIDDLE_COUNT);
      ...
      case BACK_BOTTOM:
        ...
        setArmPosition(EncoderConstants.BACK_BOTTOM_COUNT);
